...
{
    [super viewDidLoad];
    [self.navigationItem setTitle:[NSLocalizedString(@"create", nil) stringWithSentenceCapitalization]];
    
    NSString * usernamesCaseSensitive = [NSLocalizedString(@"usernames_case_sensitive", nil) stringWithSentenceCapitalization];
    NSString * pwWarning = [NSLocalizedString(@"warning_password_reset", nil) stringWithSentenceCapitalization];
    
    NSString * labelText = [NSString stringWithFormat:@"%@ %@ %@ %@",
                            [NSLocalizedString(@"enter_username_and_password", nil) stringWithSentenceCapitalization],
    ...
    [_tbUsername setPlaceholder:[NSLocalizedString(@"username", nil) stringWithSentenceCapitalization]];
    
    _tbPassword.returnKeyType = UIReturnKeyNext;
    [_tbPassword setPlaceholder:[NSLocalizedString(@"password", nil) stringWithSentenceCapitalization]];
    
    _tbPasswordConfirm.returnKeyType = UIReturnKeyGo;
    [_tbPasswordConfirm setPlaceholder:[NSLocalizedString(@"confirm_password", nil) stringWithSentenceCapitalization]];
    ...
    UIBarButtonItem *anotherButton = [[UIBarButtonItem alloc] initWithTitle:[NSLocalizedString(@"menu",nil) stringWithSentenceCapitalization] style:UIBarButtonItemStylePlain target:self action:@selector(showMenu)];
    self.navigationItem.rightBarButtonItem = anotherButton;
    
    [_bCreateIdentity setTintColor:[UIUtils surespotBlue]];
    [_bCreateIdentity setTitle:[NSLocalizedString(@"create_identity", nil) stringWithSentenceCapitalization] forState:UIControlStateNormal];
...
-(REMenu *) createMenu {
    ...
    REMenuItem * restoreItem = [[REMenuItem alloc] initWithTitle:[NSLocalizedString(@"import_identities", nil) stringWithSentenceCapitalization] image:[UIImage imageNamed:@"ic_menu_archive"] highlightedImage:nil action:^(REMenuItem * item){
    ...
    REMenuItem * aboutItem = [[REMenuItem alloc] initWithTitle:[NSLocalizedString(@"about", nil) stringWithSentenceCapitalization] image:[UIImage imageNamed:@"app_icon"] highlightedImage:nil action:^(REMenuItem * item){
        [self showAbout];
    }];
