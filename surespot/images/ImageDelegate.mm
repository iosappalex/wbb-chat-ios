                                                          ...
                                                          [[NetworkController sharedInstance] postFileStreamData:encryptedImageData
                                                                                                   ...
                                                                                                   theirUsername:_theirUsername
                                                                                                    ...
                                                                                                    successBlock:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                                                                                                        ...
                                                                                                        DDLogInfo(@"uploaded data %@ to server successfully, server id: %ld, url: %@, date: %@, size: %ld", message.iv, serverid, url, date, (long)size);
                                                                                                        ...
                                                                                                        DDLogInfo(@"uploaded image %@ to server failed, statuscode: %ld", key, responseObject.statusCode);
                                                                                                        [self stopProgress];
