...
const NSInteger SEND_THRESHOLD = 10;
...
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag {
    DDLogInfo(@"finished playing, successfully?: %d", flag);
    [self stopPlayingDeactivateSession:YES];
}
                                                          ...
                                                          [[NetworkController sharedInstance] postFileStreamData:encryptedVoiceData
                                                                                                   ...
                                                                                                   theirUsername:_theirUsername
                                                                                                    ...
                                                                                                    successBlock:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                                                                                                        ...
                                                                                                        DDLogInfo(@"uploaded voice data %@ to server successfully, server id: %ld, url: %@, date: %@, size: %ld", message.iv, serverid, url, date, (long)size);
                                                                                                    ...
                                                                                                    failureBlock:^(NSURLRequest *operation, NSHTTPURLResponse *responseObject, NSError *Error, id JSON) {
                                                                                                        ...
                                                                                                        DDLogInfo(@"uploaded voice %@ to server failed, statuscode: %ld", key, responseObject.statusCode);
                                                                                                        //  [self stopProgress];
